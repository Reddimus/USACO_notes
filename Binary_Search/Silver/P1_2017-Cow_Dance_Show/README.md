...
## [Problem 1. Cow Dance Show](http://www.usaco.org/index.php?page=viewproblem2&cpid=690)
...
## Hints:
- We need to **search** for the smallest possible stage size that adheres to the contract's time constraints.
- A `minimum heap-priority queue` data structure forces the cow with the shortest dance time to exit the stage first and is best suited for figuring out the total time elapsed with `k` cows on stage.

# [Solutions](https://github.com/Reddimus/USACO_notes/tree/main/Binary_Search/Silver/P1_2017-Cow_Dance_Show)

## Binary Search w/ Heap-Priority Queue Approach
